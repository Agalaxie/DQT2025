      ...
      return (
        <>
          ...
          <Select>
            ...
            >
              <SelectValue placeholder="Assigner un réviseur" />
            </SelectTrigger>
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            <SelectItem value="outline">Plan</SelectItem>
            <SelectItem value="past-performance">Performances passées</SelectItem>
        ...
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          <TabsTrigger value="outline">Plan</TabsTrigger>
          <TabsTrigger value="past-performance">
            Performances passées <Badge variant="secondary">3</Badge>
          </TabsTrigger>
      ...
      <DrawerContent>
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
            ...
            <>
              ...
              <div className="grid gap-2">
                ...
                <div className="text-muted-foreground">
                  Affichage du total des visiteurs pour les 6 derniers mois. Ceci est juste
                  un texte aléatoire pour tester la mise en page. Il s'étend sur plusieurs lignes
                  et devrait s'enrouler.
                </div>
              </div>
              <Separator />
            </>
          ...
          <form className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <Label htmlFor="reviewer">Réviseur</Label>
